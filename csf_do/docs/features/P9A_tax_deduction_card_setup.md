## RST Declaration Tax Deduction Card Setup

### Salary Component Mapping for RST Declaration

This guide explains the process of mapping salary components to the RST Declaration Tax Deduction Card Type in a Frappe-based system. Follow these steps to configure and manage the salary components effectively.
...
3. **Click on "Salary Component" to view and manage the components.**
  ![image](https://github.com/navariltd/navari_csf_do/assets/99787384/5a45a003-6566-481b-8c86-6beee8c7577d)
...
5. **Click on "Add Salary Component " to add a new component.**
  <img width="958" alt="Capture 256" src="https://github.com/navariltd/navari_csf_do/assets/99787384/73299625-9ce4-4d87-89f6-c6398b7d8ec8">
...
8. **RST Declaration Tax Deduction Card Type**: Set this field using the value from the "RST Declaration Tax Deduction Card Type" column.
...
13. Test the payroll calculations to ensure the formulas are working correctly and the tax deductions are being applied as per the RST Declaration card types.
...
- Double-check the RST Declaration tax deduction card types to ensure compliance with your local tax regulations.
