# RST Declaration Tax Deduction Card Report

## Overview

The RST Declaration Tax Deduction is a mandatory tax report for employees in Dominican Republic. It retrieves salary components, calculates retirement contributions, determines taxable income, and outputs a structured table for each employee across a fiscal year.

## Features

**Comprehensive Data:** Captures all necessary information for the RST Declaration form, including:
- ✅   Basic Salary
...
1.  **Accessing the Report:** Once installed, you can access the report through the ERPNext user interface. Go to "Dominican Republic Workspace" -> "RST Declaration Tax Deduction Card Report" or on the "Awesome Searchbar"
...
![p9 Tax Report](../images/dominican_p9_tax_report.png)