...
from csf_do.csf_do.utils.ecf33_builder import build_and_validate_ecf33


class TestECF33Builder(unittest.TestCase):
    def test_valid_ecf33_minimal(self):
        data = {
            "encabezado": {
                "Version": "1.0",
                "IdDoc": {
        ...
        xml, ok, errores = build_and_validate_ecf33(data)
