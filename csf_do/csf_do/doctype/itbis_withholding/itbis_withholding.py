...
class ITBISWithholding(Document):
    ...
    def set_missing_values(self):
        ...
        if self.outstanding_amount and self.itbis_withholding_amount:
            if self.outstanding_amount == self.itbis_withholding_amount:
    ...
    def on_submit(self):
        ...
        frappe.db.set_value(
            "ITBIS Withholding", self.name, "journal_entry", journal_entry
        )
    ...
    def create_journal_entry(doc, method, *args, **kwargs):
        ...
        remark = (
            f"Payment for Sales Invoice {doc.voucher_no} via ITBIS Withholding {doc.wht_certificate_no}"
            if kwargs.get("allocate_payment")
            else f"ITBIS Withholding Acknowledgment - Cert No: {doc.wht_certificate_no}"
        )
                ...
                "accounts": [
                    {
                        ...
                        "debit_in_account_currency": doc.itbis_withholding_amount,
                        "party_type": "",
                        "party": "",
                        "reference_type": "",
                        "reference_name": "",
                    },
                    {
                        ...
                        "credit_in_account_currency": doc.itbis_withholding_amount,
                        "party_type": "Customer",
                        "party": doc.customer,
