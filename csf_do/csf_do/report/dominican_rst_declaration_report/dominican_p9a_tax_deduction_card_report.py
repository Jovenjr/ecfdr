...
def validate_dates(p9a_year_start_date, p9a_year_end_date):
    if not p9a_year_start_date or not p9a_year_end_date:
        frappe.throw("RST Declaration Year Start Date and RST Declaration Year End Date are mandatory")
    if p9a_year_end_date < p9a_year_start_date:
        frappe.throw("RST Declaration Year End Date cannot be less than RST Declaration Year Start Date")
