...
frappe.query_reports["Dominican Republic RST Declaration Tax Deduction Card Report"] = {
  onload(report) {
    report.page.add_inner_button("Print", function () {
      ...
      const url = `/api/method/csf_do.csf_do.report.dominican_p9a_tax_deduction_card_report.custom_dominican_p9a_tax_deduction_card_print_report.print_report?report_name=${reportName}&filters=${encodedFilters}`;
