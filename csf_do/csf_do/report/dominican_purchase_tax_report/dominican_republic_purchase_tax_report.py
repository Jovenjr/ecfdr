...
def execute(filters=None):
    return DominicanRepublicPurchaseTaxReport(filters).run()


class DominicanRepublicPurchaseTaxReport(object):
    def __init__(self, filters=None):
        self.filters = frappe._dict(filters or {})
        self.registered_suppliers_total_purchases = 0
        self.registered_suppliers_total_itbis = 0
        self.unregistered_suppliers_total_purchases = 0
        self.unregistered_suppliers_total_itbis = 0
    ...
    def get_columns(self):
        columns = [
            {
                "label": _("RNC of supplier"),
                "fieldname": "rnc_of_supplier",
                "fieldtype": "Data",
                "width": 160,
            },
            {
    ...
    def get_data(self):
        ...
        for report_entry in report_details:
            if report_entry["pin_of_supplier"]:
                ...
                self.registered_suppliers_total_itbis += report_entry["amount_of_vat"]
            else:
                self.unregistered_suppliers_total_purchases += report_entry[
                    "invoice_total_purchases"
                ]
                self.unregistered_suppliers_total_itbis += report_entry["amount_of_vat"]
    ...
    def get_report_summary(self):
        return [
            ...
            {
                "value": self.registered_suppliers_total_itbis,
                "indicator": "Green",
                "label": _("Registered suppliers total ITBIS"),
                "datatype": "Currency",
                "currency": "KES",
            },
            {
            ...
            {
                "value": self.unregistered_suppliers_total_itbis,
                "indicator": "Green",
                "label": _("Unregistered suppliers total ITBIS"),
                "datatype": "Currency",
                "currency": "KES",
            },
        ]
    ...
    for template_name in tax_templates:
        ...
        for template in all_tax_templates:
            ...
            if match:
                ...
                purchase_invoices = DominicanRepublicPurchaseTaxReport({
                    "company": company,
                    "from_date": from_date,
                    "to_date": to_date,
