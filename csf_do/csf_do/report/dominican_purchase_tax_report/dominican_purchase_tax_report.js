...
frappe.query_reports["Dominican Republic Purchase Tax Report"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
    ...
    "onload": function(report) {
        report.page.add_menu_item('Export CSVs', function() {
            frappe.call({
                method: "csf_do.csf_do.report.dominican_purchase_tax_report.dominican_purchase_tax_report.download_custom_csv_format",
                args: {
